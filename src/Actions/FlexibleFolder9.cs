...
{
    public class FlexibleFolder9 : PluginDynamicFolder
    {
        ...
        private void OnFlexibleFoldersUpdated(object sender, EventArgs e)
        {
            ...
            {
                DebugLogger.Log($"[FlexibleFolder9] OnFlexibleFoldersUpdated ButtonActionNamesChanged failed: {ex.Message}");
            }
        }
        ...
        private void UpdateDisplayName()
        {
            ...
            if (folder != null)
                ...
                DisplayName = "Flexible Folder 9 (Empty)";
        }
        ...
        public override IEnumerable<string> GetButtonPressActionNames()
        {
            ...
            DebugLogger.Log($"[FlexibleFolder9] Current level '{currentLevel.Name}' has {currentLevel.Buttons.Count} buttons");
        ...
        private void ExecuteAction(FlexibleButton button)
        {
            ...
            switch (button.ActionType)
            {
                ...
                case "Temperature":
                    ...
                    DebugLogger.Log($"[FlexibleFolder9] Action {button.ActionType} requires submenu - not yet implemented");
                    break;

                default:
                    DebugLogger.Log($"[FlexibleFolder9] Unknown action type: {button.ActionType}");
                    break;
            }
        }
