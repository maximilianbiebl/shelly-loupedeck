...
{
    public class FlexibleFolder3 : PluginDynamicFolder
    {
        ...
        private void OnFlexibleFoldersUpdated(object sender, EventArgs e)
        {
            ...
            {
                DebugLogger.Log($"[FlexibleFolder3] OnFlexibleFoldersUpdated ButtonActionNamesChanged failed: {ex.Message}");
            }
        }
        ...
        private void UpdateDisplayName()
        {
            ...
            if (folder != null)
                ...
                DisplayName = "Flexible Folder 3 (Empty)";
        }
        ...
        public override IEnumerable<string> GetButtonPressActionNames()
        {
            ...
            DebugLogger.Log($"[FlexibleFolder3] Current level '{currentLevel.Name}' has {currentLevel.Buttons.Count} buttons");
        ...
        private void ExecuteAction(FlexibleButton button)
        {
            ...
            switch (button.ActionType)
            {
                ...
                case "Temperature":
                    ...
                    DebugLogger.Log($"[FlexibleFolder3] Action {button.ActionType} requires submenu - not yet implemented");
                    break;

                default:
                    DebugLogger.Log($"[FlexibleFolder3] Unknown action type: {button.ActionType}");
                    break;
            }
        }
