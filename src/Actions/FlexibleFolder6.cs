...
{
    public class FlexibleFolder6 : PluginDynamicFolder
    {
        ...
        private void OnFlexibleFoldersUpdated(object sender, EventArgs e)
        {
            ...
            {
                DebugLogger.Log($"[FlexibleFolder6] OnFlexibleFoldersUpdated ButtonActionNamesChanged failed: {ex.Message}");
            }
        }
        ...
        private void UpdateDisplayName()
        {
            ...
            if (folder != null)
                ...
                DisplayName = "Flexible Folder 6 (Empty)";
        }
        ...
        private void ExecuteAction(FlexibleButton button)
        {
            ...
            switch (button.ActionType)
            {
                ...
                case "Temperature":
                    ...
                    DebugLogger.Log($"[FlexibleFolder6] Action {button.ActionType} requires submenu - not yet implemented");
                    break;

                default:
                    DebugLogger.Log($"[FlexibleFolder6] Unknown action type: {button.ActionType}");
                    break;
            }
        }
