...
{
    public class FlexibleFolder4 : PluginDynamicFolder
    {
        ...
        private void OnFlexibleFoldersUpdated(object sender, EventArgs e)
        {
            ...
            {
                DebugLogger.Log($"[FlexibleFolder4] OnFlexibleFoldersUpdated ButtonActionNamesChanged failed: {ex.Message}");
            }
        }
        ...
        private void UpdateDisplayName()
        {
            ...
            if (folder != null)
                ...
                DisplayName = "Flexible Folder 4 (Empty)";
        }
        ...
        public override IEnumerable<string> GetButtonPressActionNames()
        {
            ...
            DebugLogger.Log($"[FlexibleFolder4] Current level '{currentLevel.Name}' has {currentLevel.Buttons.Count} buttons");
        ...
        private void ExecuteAction(FlexibleButton button)
        {
            ...
            switch (button.ActionType)
            {
                ...
                case "Temperature":
                    ...
                    DebugLogger.Log($"[FlexibleFolder4] Action {button.ActionType} requires submenu - not yet implemented");
                    break;

                default:
                    DebugLogger.Log($"[FlexibleFolder4] Unknown action type: {button.ActionType}");
                    break;
            }
        }
